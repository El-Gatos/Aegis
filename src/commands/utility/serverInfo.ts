...
import { SlashCommandBuilder, ChatInputCommandInteraction, EmbedBuilder, ChannelType, GuildVerificationLevel } from 'discord.js';
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const infoEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                {
                    name: 'Created At',
                    value: `<t:${Math.floor(interaction.guild.createdTimestamp / 1000)}:F>`, // e.g., "August 30, 2018 1:17 PM"
                    inline: true
                },
                {
                    name: 'Channels',
                ...
                { name: 'Emoji Count', value: interaction.guild.emojis.cache.size.toString(), inline: true },
            )
