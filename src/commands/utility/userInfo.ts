...
export const command: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const targetMember = (interaction.options.getMember('target') || interaction.member) as GuildMember;
        ...
        const infoEmbed = new EmbedBuilder()
            ...
            .addFields(
                ...
                {
                    name: 'Joined Server',
                    value: targetMember.joinedAt ? `<t:${Math.floor(targetMember.joinedAt.getTime() / 1000)}:R>` : 'Unknown',
                    inline: true
                },
